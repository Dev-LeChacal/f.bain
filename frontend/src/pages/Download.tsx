...
const Download = () => {
    ...
    useEffect( () => {
        ...
        if ( !uuid || !hash ) {
            ...
            return setProgress( { status: 'error', text: 'Invalid link', progress: 1 } )
        }
            ...
            <div className="flex flex-col items-center max-w-[min(500px,90vw)] w-full mx-4">
                <div className="flex flex-row items-center gap-4">
                    <div className="text-left">
                        ...
                        <Button onPress={ handleDownload } label={ progress.text } color={ progressColor }/>
                        <Button onPress={ handleDelete } label="Delete" color={ progressColor }/>
                    </div>
                </div>
